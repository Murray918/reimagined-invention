...
let $h4 = '<h4 class="dog"> Mack </h4><h4 class="wand"> Twisted Holly Wand</h4>'
let $unorderedList = '<ul storage="trunk"> <li class ="beer">butter beer</li> <li class="secret">invisibility cloak</li> <li class="secret">magic map</li> <li class="secret">time turner</li> <li class="dog">leash</li> <li>Bertie Botts Every Flavor [Jelly] Beans.</li></ul>'
...
$('h4').after("<h4>SUPER DUPER FLY WAND</h4>");
$('h4').last().css({'color': 'indigo'})

$('.secret').hide('slow').delay(2000).show(2000)
